...
from voice_mode.config import TTS_BASE_URLS, STT_BASE_URLS, TTS_VOICES
            ...
            for url in urls:
                if optimistic:
                    ...
                    provider_registry.registry[service][url] = EndpointInfo(
                        ...
                        voices=[] if service == "stt" else (["alloy", "echo", "fable", "nova", "onyx", "shimmer"] if "openai.com" in url else TTS_VOICES),
