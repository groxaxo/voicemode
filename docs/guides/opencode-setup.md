...
**File location:** `~/.config/opencode/opencode.json` (global) or `opencode.json` (project-specific)
...
**Solutions:**
1. Verify `~/.config/opencode/opencode.json` exists and has correct syntax
2. Check the `mcp` section is properly formatted
